 ...
 */
final class Version20200409220635 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE receipt ADD ingrediants_id INT NOT NULL, ADD image_name VARCHAR(500) NOT NULL, DROP author_id');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE receipt ADD author_id INT DEFAULT NULL, DROP ingrediants_id, DROP image_name');
